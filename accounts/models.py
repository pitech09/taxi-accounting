"""
Core app models – SystemSettings singleton and related configuration.
"""
...
class SystemSettings(models.Model):
    ...
    contract_settlement_day = models.IntegerField(default=1,
                                                   help_text="Day of month when contract is settled")
    ...
    def get_settings(cls):
        """Return the singleton SystemSettings instance, creating it if necessary."""
